### 💡 Concept: One Team. One Date.
Launched on **Valentine's Day 2026**, InsertDate is a **minimalist Windows utility** designed as a gift of consistency for your organization. 
It eliminates the friction of fragmented date formatting. By removing customization, it ensures every team member produces the exact same output, every time.

### 🛠 How it Works
- **System-Wide Hotkey**: While the app is running in your system tray, press the **Insert** key to input the current date into **any Windows application**.
- Perfect for unifying reports, invoices, and file naming across your entire team.

### 🛡 Trusted & Verified
- **Digitally Signed**: Verified by **Microsoft Windows** with an **SSL.com IV Code Signing Certificate** for your security.
